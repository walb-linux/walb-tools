...
class Test_getGidToRepl(unittest.TestCase):
    def test(self):
        ...
        expectTbl = [
            (0, None), (200, 3), (400, 5), (600, 7), (800, 9), (1000, 9)
        ]
        for (size, ret) in expectTbl:
            self.assertEqual(ret, getGidToRepl(diffL, size, 0))
        expectTbl = [
            (0, 3), (1, 4), (2, 5), (5, 8), (6, 9), (7, 9)
        ]
        for (start, ret) in expectTbl:
            self.assertEqual(ret, getGidToRepl(diffL, 200, start))

        diffL = map(create_diff_from_str, [
            '|1193|-->|58086| -- 2016-06-09T02:16:12 5832832',
            '|58086|-->|58087,58112| -- 2016-06-09T09:04:45 4748880279',
            '|58087|-->|58112| -- 2016-06-09T09:05:42 23251',
            '|58112|-->|58625| -- 2016-06-10T06:04:39 392851',
            '|58625|-->|58626| M- 2016-06-10T06:04:40 10796',
            '|58626|-->|58627| M- 2016-06-10T06:04:45 8294',
            '|58627|-->|58628| M- 2016-06-10T06:04:56 8289',
            '|58628|-->|58629| M- 2016-06-10T06:14:39 11411',
            '|58629|-->|58630| M- 2016-06-10T06:14:40 10796',
            '|58630|-->|58631| M- 2016-06-10T06:14:45 8294',
            '|58631|-->|58632| M- 2016-06-10T06:14:56 8289',
        ])
        expectTbl = [
            (58086, 58632), (58087, 58632)
        ]
        for (start, ret) in expectTbl:
            self.assertEqual(ret, getGidToRepl(diffL, UINT64_MAX, start))
