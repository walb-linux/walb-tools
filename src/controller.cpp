...
const protocol::GetCommandInfoMap &getGetCommandInfoMap()
{
    static const protocol::GetCommandInfoMap m = {
        ...
        {diffTN, {protocol::StringVecType, verifyVolIdAndGidRangeParamForGet, "[volId (gidB (gidE))] get diff list (archive)."}},
        {proxyDiffTN, {protocol::StringVecType, verifyVolIdAndArchiveNameParamForGet, "[volId (archive))] get diff list (proxy)."}},
        {applicableDiffTN, {protocol::StringVecType, verifyApplicableDiffParamForGet, "[volId (maxGid)] get applicable diff list (archive)."}},
